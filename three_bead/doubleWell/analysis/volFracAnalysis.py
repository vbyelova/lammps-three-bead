...
refoldBarrier = 2
numRuns = 5
volfracs = [0.04, 0.07, 0.10]
numMolecules = [18007, 3939, 3904]
boxLength = 100

for vf, numMol in volfracs, numMolecules:
    ...
    for runNum in range(numRuns):
        ...
        if not os.path.exists(f"../runs/{conditions}/{filename}/analysis/percDims.pkl"):
            ...
            percDims = getPercDims(unfoldBarrier, refoldBarrier, runNum, vf, numMol, timesteps)
